            ...
            <div className="flex-1 justify-items-start">
                <div className="p-2 m-4 bg-emerald-950 w-80 justify-items-center">
                    <input
                        ...
                        className="rounded-lg w-full mt-1 border-2 border-gray-300 p-2 font-sans text-black"
                        value={name}
                        required
                        onChange={(event) => setName(event.target.value)}
                    />
                    <div className="mt-5">Quantity: {quantity}</div>
                    ...
                    <div className="mt-5">
                        <label>
                            Category:
                            <select
                                className="rounded-lg h-7 ml-2 text-black font-sans"
                                required
                                value={category}
                    ...
                    <button
                        type="submit"
                        className="w-full text-xs p-3 mt-7 py-2 font-semibold text-white bg-emerald-700 rounded-lg shadow-md hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:ring-opacity-75 transition duration-200"
                    >
                        Add Item
                    </button>
